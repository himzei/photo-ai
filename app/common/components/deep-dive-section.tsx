...
export function DeepDiveSection({ newsItems }: DeepDiveSectionProps) {
  ...
  return (
    <div className="bg-white py-8 rounded-lg overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex gap-8 items-start">
          {/* 왼쪽 헤더 섹션 */}
          <div className="flex-shrink-0 w-80">
            <div className="space-y-2">
              <h3 className=" font-medium text-black">Only 비스트포</h3>
              ...
              <div className="flex gap-5">
                {newsItems.map((news, index) => (
                  ...
                  >
                    ...
                    {/* 헤드라인 */}
                    <div className="p-4 bg-white/50 backdrop-blur-sm absolute bottom-0 left-0 right-0 h-1/2 rounded-xl">
                      <h4 className="text-base font-semibold line-clamp-2 mb-2 text-black">
                        {news.headline}
                      </h4>
                      {/* 타임스탬프 */}
                      <span className="text-xs text-gray-900 whitespace-nowrap flex justify-end mb-2">
                        {news.timestamp}
                      </span>
                      {/* 태그와 타임스탬프 */}
