...
import { mainPickNews, rankingNews, deepDiveNews } from "../main-data";
...
export const meta: MetaFunction = () => {
  return [
    { title: "Home | 비트스포" },
    { name: "description", content: "비트스포 홈페이지 방문을 환영합니다." },
  ];
};
...
export default function HomePage() {
  // 뉴스 데이터를 3개씩 묶어서 처리 (큰 기사 1개 + 작은 기사 2개)
    ...
    <div className="bg-muted py-4 ">
      <div className="container mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          {/* 왼쪽: PICK 뉴스 섹션 */}
          <div className="lg:col-span-2 rounded-lg bg-white flex flex-col">
            {/* 헤더 */}
            ...
            <div className="mb-6">
              ...
              >
                <TabsList className="bg-transparent py-0 px-1 h-auto gap-6">
                  <TabsTrigger
                    value="all"
                    className="cursor-pointer data-[state=active]:bg-transparent data-[state=active]:border-t-0 data-[state=active]:border-r-0 data-[state=active]:border-l-0 data-[state=active]:text-black data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-black data-[state=active]:rounded-none text-gray-400 border-b-2 border-transparent px-0 pb-2"
                  >
                    전체
                  </TabsTrigger>
                  <TabsTrigger
                          ...
                          <CardContent className="p-0">
                            <div className="flex gap-4">
                              ...
                              <div className="flex-1 py-4">
                                ...
                                {/* 요약 텍스트 (헤드라인 일부 사용) */}
                                <p
                                  className="text-sm text-gray-600 mb-2 line-clamp-2 group-hover:text-gray-500/50 
                                ...
                                {/* 타임스탬프 */}
                                <p className="text-xs text-gray-500 group-hover:text-gray-500/50 transition-colors duration-300">
                                  {news.timestamp}
                                </p>
                              </div>
                              {/* 오른쪽: 이미지 */}
