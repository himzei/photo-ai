...
const generateDummyPosts = (
  ...
  return Array.from({ length: count }, (_, i) => ({
    id: i + 1,
    title: `${category === "popular" ? "인기 " : category === "discussion" ? "토론 " : ""}게시물 제목 ${i + 1}: 암호화폐 시장 동향 분석`,
    content: `이것은 게시물 ${i + 1}의 내용입니다. 암호화폐 시장의 최신 동향과 분석을 제공합니다. 블록체인 기술과 디지털 자산에 대한 심층적인 정보를 다룹니다.`,
    author: `사용자${i + 1}`,
    authorAvatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=user${i + 1}`,
        ...
        <Link to={`/community/post/${post.id}`} className="block">
          <div className="p-6 space-y-3">
            ...
            <div className="space-y-1">
              ...
              {/* 내용 미리보기 */}
              <p className="text-sm text-gray-600 line-clamp-2 group-hover:text-gray-500 transition-colors">
                {post.content}
              </p>
